...
<body>
    ...
    <button type="submit"><a href="mayor.php">Mayor a $500</a></button>
    <h2>Lista de ropa</h2>
    ...
    <table border="1">
        ...
        // => Selecciona los siguientes c'ampos de la siguiente tabla
        $consulta = "SELECT * FROM tienda WHERE tipodeprenda = 'buzo'";
